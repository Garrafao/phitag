...
export default class WSSIMJudgementId implements IJudgementId {
    ...
    static fromDto(dto: IJudgementIdDto): WSSIMJudgementId {
        return new WSSIMJudgementId(
            dto.id,
            dto.instanceId,
            dto.annotator,
            dto.phase,
...
export class WSSIMJudgementIdConstructor implements IJudgementIdConstructor {
    fromDto(dto: IJudgementIdDto): IJudgementId {
        return WSSIMJudgementId.fromDto(dto);
    }
}