...
public class UseRankPairTutorialJudgementQueryJpa implements Specification<UseRankPairTutorialJudgement> {

    private final Query query;

    public UseRankPairTutorialJudgementQueryJpa(final Query query) {
        this.query = query;
    }

    @Override
    public Predicate toPredicate(Root<UseRankPairTutorialJudgement> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
        final List<Specification<UseRankPairTutorialJudgement>> specifications = new ArrayList<>();
