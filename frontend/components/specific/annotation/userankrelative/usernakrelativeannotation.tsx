...
const UseRankRelativeAnnotation: React.FC<{ phase: Phase }> = ({ phase }) => {
        ...
        <div className="w-full flex flex-col justify-between">
            ...
            <div className="w-full bg-gray-600 shadow-md text-white">
                <div className="px-10 m-0 flex flex-row">
                    ...
                    <div className="border-r-2 mx-4" />
                    <div className="my-4 font-dm-mono-light text-lg overflow-auto">
                        {usageContextBuilder(annotation.instance?.getFirstusage()).map((sentence, index) => {
                            return (
                                <span
                                    key={index}
                                    className={
            ...
            <Draggable usages={filteredUsages} handleUsagesReordered={handleUsagesReordered} containerSize={selectedSize} />
...
export default UseRankRelativeAnnotation;
