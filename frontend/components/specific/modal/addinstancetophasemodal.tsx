...
const AddInstanceToPhaseModal: React.FC<{ isOpen: boolean, closeModalCallback: Function, phase: Phase, mutateCallback: Function }> = ({ isOpen, closeModalCallback, phase, mutateCallback }) => {
    ...
    const onConfirm = () => {
        ...
        // @ts-ignore
        addInstance(phase.getId().getOwner(), phase.getId().getProject(), phase.getId().getPhase(), modalState.selectedFile, false, storage.get)
            .then((phase) => {
                        ...
                        <div className="mx-4">
                            <div className="flex flex-col items-left mt-6">
                                ...
                                <div className="font-dm-mono-regular my-2">
                                    You are about to add new instances to the phase.
                                </div>
...
export default AddInstanceToPhaseModal;
