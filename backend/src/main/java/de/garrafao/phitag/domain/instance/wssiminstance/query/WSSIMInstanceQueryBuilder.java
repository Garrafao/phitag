...
public class WSSIMInstanceQueryBuilder {

    private final List<QueryComponent> queryComponents;

    public WSSIMInstanceQueryBuilder() {
        this.queryComponents = new ArrayList<>();
    }

    public WSSIMInstanceQueryBuilder withInstanceid(final String instanceid) {
    ...
    public WSSIMInstanceQueryBuilder withOwner(final String owner) {
    ...
    public WSSIMInstanceQueryBuilder withProject(final String project) {
    ...
    public WSSIMInstanceQueryBuilder withPhase(final String phase) {
