...
public class LexSubJudgementQueryJpa implements Specification<LexSubJudgement> {

    private final Query query;

    public LexSubJudgementQueryJpa(final Query query) {
        this.query = query;
    }

    @Override
    public Predicate toPredicate(Root<LexSubJudgement> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
        final List<Specification<LexSubJudgement>> specifications = new ArrayList<>();
