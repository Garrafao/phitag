...
import SentimentTutorialTable from "./sentimenttutorialtable";
import SentimentTutorialAnnotation from "./sentimenttutorialannotation";

const SentimentTutorial: React.FC<{ phase: Phase }> = ({ phase }) => {
    ...
    const handleFinalizeAnnotation = () => {
        bulkAnnotateSentiment(tutorialAnnotation.annotatedInstances, storage.get).then(() => {
        ...
        return (
            <Layout>
                ...
                <SingleContentLayout>
                    ...
                    <div className="m-8">
                        {/* @ts-ignore, fix later */}
                        <SentimentTutorialTable data={tutorialAnnotation.annotatedInstances} instances={instances.data} />
                    </div>
        ...
        <Layout>
            ...
            <SingleContentLayout>
                ...
                <div className="mt-2 xl:mt-10">
                    {/* @ts-ignore, fix later */}
                    <SentimentTutorialAnnotation instance={instances.data[tutorialAnnotation.currentAnnotation]} handleSubmitAnnotation={handleSubmitAnnotation} />
                </div>
...
export default SentimentTutorial;