...
public class LexSubTutorialJudgementQueryJpa implements Specification<LexSubTutorialJudgement> {

    private final Query query;

    public LexSubTutorialJudgementQueryJpa(final Query query) {
        this.query = query;
    }

    @Override
    public Predicate toPredicate(Root<LexSubTutorialJudgement> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
        final List<Specification<LexSubTutorialJudgement>> specifications = new ArrayList<>();
