...
@Getter
public class AddSentimentAndChoiceJudgementCommand implements IAddJudgementCommand {
    ...
    public AddSentimentAndChoiceJudgementCommand(String owner, String project, String phase, String instance, String label,
                                                 String comment) {
