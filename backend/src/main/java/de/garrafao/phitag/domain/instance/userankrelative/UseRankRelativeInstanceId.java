...
@Data
@Embeddable
public class UseRankRelativeInstanceId implements Serializable, IInstanceId {
    ...
    public UseRankRelativeInstanceId() {
    }

    public UseRankRelativeInstanceId(String instanceid, PhaseId phaseid) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj == null || getClass() != obj.getClass())
            return false;
        UseRankRelativeInstanceId other = (UseRankRelativeInstanceId) obj;
