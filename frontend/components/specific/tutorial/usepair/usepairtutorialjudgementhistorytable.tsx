...
import { useFetchPagedHistoryUsePairTutorialJudgements } from "../../../../lib/service/tutorial/tutorialresources";

const UsePairTutorialJudgementHistoryTable: React.FC<{ phase: Phase }> = ({ phase }) => {

    const storage = useStorage();
    const [page, setPage] = useState(0);
    const usepairjudgements = useFetchPagedHistoryUsePairTutorialJudgements(phase?.getId().getOwner(), phase?.getId().getProject(), phase?.getId().getPhase(), page, !!phase);
...
export default UsePairTutorialJudgementHistoryTable;
