...
public class UseRankRelativeJudgementQueryJpa implements Specification<UseRankRelativeJudgement> {

    private final Query query;

    public UseRankRelativeJudgementQueryJpa(final Query query) {
        this.query = query;
    }

    @Override
    public Predicate toPredicate(Root<UseRankRelativeJudgement> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
        final List<Specification<UseRankRelativeJudgement>> specifications = new ArrayList<>();
