...
// model
import { editUserank, editUserankrelative } from "../../../lib/service/judgement/JudgementResource";
...
const EditUseRankRelativeJudgementModal: React.FC<EditUseRankRealtiveJudgementModalProps> = ({ judgement, isOpen, closeModalCallback, mutateCallback }) => {
...
export default EditUseRankRelativeJudgementModal;
