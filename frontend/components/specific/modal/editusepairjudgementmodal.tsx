...
// model
import UsePairJudgement from "../../../lib/model/judgement/usepairjudgement/model/UsePairJudgement";
import EditUsePairJudgementCommand from "../../../lib/model/judgement/usepairjudgement/command/EditUsePairJudgementCommand";
import { editUsepair } from "../../../lib/service/judgement/JudgementResource";
import DropdownSelect from "../../generic/dropdown/dropdownselect";
import DummySelectable from "../../../lib/model/dummy/DummySelectable";

interface EditUsePairJudgementModalProps {
...
const EditUsePairJudgementModal: React.FC<EditUsePairJudgementModalProps> = ({ judgement, isOpen, closeModalCallback, mutateCallback }) => {
    ...
    const onConfirm = () => {   
        ...
        const command: EditUsePairJudgementCommand = new EditUsePairJudgementCommand(
        ...
        editUsepair(command, storage.get).then(() => {
...
export default EditUsePairJudgementModal;
