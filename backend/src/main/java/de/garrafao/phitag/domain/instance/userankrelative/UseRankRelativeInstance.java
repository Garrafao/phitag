...
@Entity
@Table(name = "phitaguserankrelativeinstance")
@Getter
public class UseRankRelativeInstance implements IInstance {

    @EmbeddedId
    private UseRankRelativeInstanceId id;
    ...
    UseRankRelativeInstance() {
    }


    //constructor for 4 instances
    public UseRankRelativeInstance(final String instanceId, final Phase phase, final Usage firstusage, final Usage secondusage,
        ...
        this.phase = phase;
        this.id = new UseRankRelativeInstanceId(instanceId, phase.getId());
    ...
    public UseRankRelativeInstance(final String instanceId, final Phase phase,
    ...
    public boolean equals(Object obj) {
        ...
        UseRankRelativeInstance other = (UseRankRelativeInstance) obj;
