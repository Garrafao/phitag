...
interface IResult {
    ...
    instances: UseRankPairInstance[];
}


const UseRankPairTutorialTable: React.FC<IResult> = ({ data, instances }) => {
                         ...
                         */}
                                    ...
                                    {expandedInstances[i] && (
                                        <tr key={`${i}-expanded`}
                                            ...
                                            <td colSpan={6}>
                                            <UsageCardPair  isOpen={true} userankpairinstance={instances[i]} />
                                            </td>
                                        </tr>
                                    )}
                                </tr>
...
export default UseRankPairTutorialTable;
