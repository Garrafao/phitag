package de.garrafao.phitag.domain.judgement.userankpairjudgement.query;
...
public class UseRankPairJudgementQueryBuilder {

    private final List<QueryComponent> queryComponents;

    public UseRankPairJudgementQueryBuilder() {
        this.queryComponents = new ArrayList<>();
    }

    public UseRankPairJudgementQueryBuilder withUUID(final String UUID) {
    ...
    public UseRankPairJudgementQueryBuilder withAnnotator(final String annotator) {
    ...
    public UseRankPairJudgementQueryBuilder withAnnotatorProjectName(final String projectname) {
    ...
    public UseRankPairJudgementQueryBuilder withInstanceid(final String instanceid) {
    ...
    public UseRankPairJudgementQueryBuilder withOwner(final String owner) {
    ...
    public UseRankPairJudgementQueryBuilder withProject(final String project) {
    ...
    public UseRankPairJudgementQueryBuilder withPhase(final String phase) {
