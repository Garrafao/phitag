...
@Data
@Embeddable
public class SentimentAndChoiceTutorialJudgementId implements Serializable, IJudgementId {
    ...
    public SentimentAndChoiceTutorialJudgementId() {
    }

    public SentimentAndChoiceTutorialJudgementId(final SentimentAndChoiceAnnotationId instanceid, final AnnotatorId annotatorid) {
    ...
    public String toString() {
        return String.format("SentimentTutorialJudgementId [instanceid=%s, annotatorid=%s]", instanceid,
                annotatorid);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj == null || getClass() != obj.getClass())
            return false;
        SentimentAndChoiceTutorialJudgementId other = (SentimentAndChoiceTutorialJudgementId) obj;
