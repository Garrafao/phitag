...
import { deleteLexSub, useFetchPagedLexSubJudgements } from "../../../../lib/service/judgement/JudgementResource";
...
const LexSubJudgementTable: React.FC<{ phase: Phase, modalState: { open: boolean, callback: Function } }> = ({ phase, modalState }) => {
    ...
    const lexsubjudgements = useFetchPagedLexSubJudgements(phase?.getId().getOwner(), phase?.getId().getProject(), phase?.getId().getPhase(), page, !!phase);
    ...
    return (
        <div>
            ...
            <AddJudgementToPhaseModal isOpen={modalState.open} closeModalCallback={modalState.callback} phase={phase} mutateCallback={lexsubjudgements.mutate} />
...
export default LexSubJudgementTable;
