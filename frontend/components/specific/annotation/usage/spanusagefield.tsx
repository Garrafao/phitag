...
const SpanUsageField: React.FC<{ usage: Usage }> = ({ usage }) => {
  ...
  return (
    <div className="w-full shadow-md">
      <div className="m-8 flex flex-row">
        ...
        <div
          id="text"
          className="my-4 font-dm-mono-light text-lg overflow-auto"
 ...
 */
function usageContextBuilder(
  usage: Usage
): { sentence: string; highlight: "none" | "bold" | "color" }[] {
