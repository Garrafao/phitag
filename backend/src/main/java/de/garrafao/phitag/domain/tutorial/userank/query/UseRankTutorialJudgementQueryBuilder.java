package de.garrafao.phitag.domain.tutorial.userank.query;
...
public class UseRankTutorialJudgementQueryBuilder {

    private final List<QueryComponent> queryComponents;

    public UseRankTutorialJudgementQueryBuilder() {
        this.queryComponents = new ArrayList<>();
    }

    public UseRankTutorialJudgementQueryBuilder withUUID(final String UUID) {
    ...
    public UseRankTutorialJudgementQueryBuilder withAnnotator(final String annotator) {
    ...
    public UseRankTutorialJudgementQueryBuilder withAnnotatorProjectName(final String projectname) {
    ...
    public UseRankTutorialJudgementQueryBuilder withInstanceid(final String instanceid) {
    ...
    public UseRankTutorialJudgementQueryBuilder withOwner(final String owner) {
    ...
    public UseRankTutorialJudgementQueryBuilder withProject(final String project) {
    ...
    public UseRankTutorialJudgementQueryBuilder withPhase(final String phase) {
