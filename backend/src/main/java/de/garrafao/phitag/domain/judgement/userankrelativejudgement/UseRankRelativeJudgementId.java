...
@Data
@Embeddable
public class UseRankRelativeJudgementId implements Serializable, IJudgementId {
    ...
    public UseRankRelativeJudgementId() {
    }

    public UseRankRelativeJudgementId(final UseRankRelativeInstanceId instanceid, final AnnotatorId annotatorid) {
    ...
    public String toString() {
        return String.format("UseRankRelativeJudgementId [instanceid=%s, annotatorid=%s]", instanceid, annotatorid);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        UseRankRelativeJudgementId other = (UseRankRelativeJudgementId) obj;
