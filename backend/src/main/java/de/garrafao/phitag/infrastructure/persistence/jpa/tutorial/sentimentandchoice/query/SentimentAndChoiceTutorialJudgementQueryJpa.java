...
public class SentimentAndChoiceTutorialJudgementQueryJpa implements Specification<SentimentAndChoiceTutorialJudgement> {

    private final Query query;

    public SentimentAndChoiceTutorialJudgementQueryJpa(final Query query) {
        this.query = query;
    }

    @Override
    public Predicate toPredicate(Root<SentimentAndChoiceTutorialJudgement> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
        final List<Specification<SentimentAndChoiceTutorialJudgement>> specifications = new ArrayList<>();
