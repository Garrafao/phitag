...
public class SentimentAndChoiceJudgementQueryJpa implements Specification<SentimentAndChoiceJudgement> {

    private final Query query;

    public SentimentAndChoiceJudgementQueryJpa(final Query query) {
        this.query = query;
    }

    @Override
    public Predicate toPredicate(Root<SentimentAndChoiceJudgement> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
        final List<Specification<SentimentAndChoiceJudgement>> specifications = new ArrayList<>();
