...
// model
import { editSentiment, editUsepair } from "../../../lib/service/judgement/JudgementResource";
...
import EditSentimentJudgementCommand from "../../../lib/model/judgement/sentiment/command/EditSentimentJudgementCommand";

interface EditSentimentJudgementModalProps {
...
const EditSentimentJudgementModal: React.FC<EditSentimentJudgementModalProps> = ({ judgement, isOpen, closeModalCallback, mutateCallback }) => {
    ...
    const onConfirm = () => {
        ...
        const command: EditSentimentJudgementCommand = new EditSentimentJudgementCommand(
        ...
        editSentiment(command, storage.get).then(() => {
...
export default EditSentimentJudgementModal;
