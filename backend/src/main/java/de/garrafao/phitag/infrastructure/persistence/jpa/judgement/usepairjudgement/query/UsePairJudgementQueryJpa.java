...
public class UsePairJudgementQueryJpa implements Specification<UsePairJudgement> {
    ...
    public UsePairJudgementQueryJpa(final Query query) {
        this.query = query;
    }

    @Override
    public Predicate toPredicate(Root<UsePairJudgement> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
        final List<Specification<UsePairJudgement>> specifications = new ArrayList<>();
