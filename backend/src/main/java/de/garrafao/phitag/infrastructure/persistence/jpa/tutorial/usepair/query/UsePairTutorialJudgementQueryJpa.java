...
public class UsePairTutorialJudgementQueryJpa implements Specification<UsePairTutorialJudgement> {

    private final Query query;

    public UsePairTutorialJudgementQueryJpa(final Query query) {
        this.query = query;
    }

    @Override
    public Predicate toPredicate(Root<UsePairTutorialJudgement> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
        final List<Specification<UsePairTutorialJudgement>> specifications = new ArrayList<>();
