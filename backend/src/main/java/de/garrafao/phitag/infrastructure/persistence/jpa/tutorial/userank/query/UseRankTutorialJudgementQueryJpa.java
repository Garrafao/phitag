...
public class UseRankTutorialJudgementQueryJpa implements Specification<UseRankTutorialJudgement> {

    private final Query query;

    public UseRankTutorialJudgementQueryJpa(final Query query) {
        this.query = query;
    }

    @Override
    public Predicate toPredicate(Root<UseRankTutorialJudgement> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
        final List<Specification<UseRankTutorialJudgement>> specifications = new ArrayList<>();
