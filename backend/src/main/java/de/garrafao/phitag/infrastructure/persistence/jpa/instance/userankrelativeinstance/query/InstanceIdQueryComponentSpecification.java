...
public class InstanceIdQueryComponentSpecification implements Specification<UseRankRelativeInstance> {
...
public InstanceIdQueryComponentSpecification(final String instanceid) {
    ...
    @Override
    public Predicate toPredicate(Root<UseRankRelativeInstance> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
