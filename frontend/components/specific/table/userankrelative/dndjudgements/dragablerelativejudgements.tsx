...
interface IProps {
    ...
    editFunction: (judgement: UseRankRelativeJudgement, label: string) => void;
}
const DraggableRelativeJudgemets: React.FC<IProps> = ({ judgementData, editFunction }) => {
    ...
    const handleDragEnd = (event: any) => {
        ...
        if (active.id !== over.id) {
            setDragAndDropData((items) => {
                ...
                let judgement: UseRankRelativeJudgement = judgementData[0].judgement;
...
export default DraggableRelativeJudgemets;
