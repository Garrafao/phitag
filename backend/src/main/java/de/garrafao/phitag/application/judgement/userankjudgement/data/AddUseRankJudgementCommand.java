...
@Getter
public class AddUseRankJudgementCommand implements IAddJudgementCommand {
    ...
    public AddUseRankJudgementCommand(String owner, String project, String phase, String instance, String label,
                                      String comment) {
