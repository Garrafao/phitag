...
@Getter
public class AddUseRankPairJudgementCommand implements IAddJudgementCommand {
    ...
    public AddUseRankPairJudgementCommand(String owner, String project, String phase, String instance, String label,
                                          String comment) {
