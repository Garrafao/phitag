...
// model
import { editUserank } from "../../../lib/service/judgement/JudgementResource";
...
const EditUseRankJudgementModal: React.FC<EditUseRankJudgementModalProps> = ({ judgement, isOpen, closeModalCallback, mutateCallback }) => {
    ...
    const addLabel = () => {
        ...
        const command: EditUseRankJudgementCommand = new EditUseRankJudgementCommand(
            ...
            label ? label: "First Usage, Second Usage, Third Usage, Fourth Usage",
...
export default EditUseRankJudgementModal;
