...
@Entity
@Table(name = "phitagsentimentandchoiceinstance")
@Getter
public class SentimentAndChoiceInstance implements IInstance {

    @EmbeddedId
    private SentimentAndChoiceAnnotationId id;
    ...
    public SentimentAndChoiceInstance() {
    }
    ...
    public SentimentAndChoiceInstance(
        ...
        this.id = new SentimentAndChoiceAnnotationId(instanceId, phase.getId());
        this.phase = phase;
        this.usage = usage;
    ...
    public boolean equals(final Object obj) {
        ...
        final SentimentAndChoiceInstance other = (SentimentAndChoiceInstance) obj;
