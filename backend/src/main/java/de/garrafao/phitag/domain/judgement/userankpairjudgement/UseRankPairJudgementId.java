...
@Data
@Embeddable
public class UseRankPairJudgementId implements Serializable, IJudgementId {
    ...
    public UseRankPairJudgementId() {
    }

    public UseRankPairJudgementId(final UseRankPairInstanceId instanceid, final AnnotatorId annotatorid) {
    ...
    public String toString() {
        return String.format("UseRankPairJudgementId [instanceid=%s, annotatorid=%s]", instanceid, annotatorid);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        UseRankPairJudgementId other = (UseRankPairJudgementId) obj;
