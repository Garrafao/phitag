...
@Getter
public class AddUsePairJudgementCommand implements IAddJudgementCommand {
    ...
    public AddUsePairJudgementCommand(String owner, String project, String phase, String instance, String label,
            String comment) {
