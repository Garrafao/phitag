...
const ChoiceJudgementHistoryTable: React.FC<{ phase: Phase, modalState: { open: boolean, callback: Function } }> = ({ phase, modalState }) => {
    ...
    const sentimentjudgements = useFetchPagedHistorySentimentJudgements(phase?.getId().getOwner(), phase?.getId().getProject(), phase?.getId().getPhase(), page, !!phase);
                            ...
                            {sentimentjudgements.data.getContent().map((judgement, i) => {
                                ...
                                return (
                                    <tr key={judgement.getId().getId()}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap overflow-auto max-w-[500px]">
                                            {judgement.getLabel()}
                                        </td>
...
export default ChoiceJudgementHistoryTable;
