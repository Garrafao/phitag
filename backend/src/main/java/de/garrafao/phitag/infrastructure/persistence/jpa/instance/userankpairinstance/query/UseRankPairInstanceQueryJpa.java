...
import de.garrafao.phitag.domain.instance.userankpairinstances.query.*;
...
public class UseRankPairInstanceQueryJpa implements Specification<UseRankPairInstance> {

    private final Query query;

    public UseRankPairInstanceQueryJpa(Query query) {
        this.query = query;
    }

    @Override
    public Predicate toPredicate(Root<UseRankPairInstance> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
        final List<Specification<UseRankPairInstance>> specifications = new ArrayList<>();
