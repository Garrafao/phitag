...
import { useFetchPagedHistorySentimentTutorialJudgements } from "../../../../lib/service/tutorial/tutorialresources";

const SentimentTutorialJudgementHistoryTable: React.FC<{ phase: Phase }> = ({ phase}) => {
    ...
    const sentimentjudgements = useFetchPagedHistorySentimentTutorialJudgements(phase?.getId().getOwner(), phase?.getId().getProject(), phase?.getId().getPhase(), page, !!phase);
...
export default SentimentTutorialJudgementHistoryTable;
