...
import de.garrafao.phitag.domain.judgement.sentimentandchoice.error.SentimentAndJudgementException;
...
@Service
public class SentimentJudgementApplicationService {
    ...
    @Autowired
    public SentimentJudgementApplicationService(
