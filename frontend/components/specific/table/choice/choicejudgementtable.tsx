...
import { deleteJudgement, deleteLexSub, useFetchPagedLexSubJudgements, useFetchPagedSentimentJudgements } from "../../../../lib/service/judgement/JudgementResource";
...
const ChoiceJudgementTable: React.FC<{ phase: Phase, modalState: { open: boolean, callback: Function } }> = ({ phase, modalState }) => {
...
export default ChoiceJudgementTable;
