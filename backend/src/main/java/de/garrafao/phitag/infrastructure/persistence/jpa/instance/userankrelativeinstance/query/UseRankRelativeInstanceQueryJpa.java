...
import de.garrafao.phitag.domain.instance.userankrelative.query.*;
...
public class UseRankRelativeInstanceQueryJpa implements Specification<UseRankRelativeInstance> {

    private final Query query;

    public UseRankRelativeInstanceQueryJpa(Query query) {
        this.query = query;
    }

    @Override
    public Predicate toPredicate(Root<UseRankRelativeInstance> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {

        final List<Specification<UseRankRelativeInstance>> specifications = new ArrayList<>();
