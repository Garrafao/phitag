...
import { addJudgement } from "../../../lib/service/judgement/JudgementResource";

const AddJudgementToPhaseModal: React.FC<{ isOpen: boolean, closeModalCallback: Function, phase: Phase, mutateCallback: Function }> = ({ isOpen, closeModalCallback, phase, mutateCallback }) => {
    ...
    const onConfirm = () => {
        ...
        // @ts-ignore
        addJudgement(phase.getId().getOwner(), phase.getId().getProject(), phase.getId().getPhase(), modalState.selectedFile, storage.get)
            .then((phase) => {
                toast.success("Successfully added judgements");
    ...
    const onCancel = () => {
        toast.info("Canceled adding judgements to phase");
        // close modal
        setModalState({
            selectedFile: null as unknown as File,
        })
                        ...
                        <div className="mx-4">
                            <div className="flex flex-col items-left mt-6">
                                ...
                                <div className="font-dm-mono-regular my-2">
                                    You are about to add new judgements to the phase.
                                </div>
...
export default AddJudgementToPhaseModal;
